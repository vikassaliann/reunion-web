      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-8 py-12 text-center space-y-10">
        <div className="space-y-3">
          ...
          <h2 className="font-cormorant text-[clamp(2rem,5vw,3rem)] font-light text-white leading-tight">
            Reach <em className="text-[#C9A84C]">Reunion</em>
          </h2>
        ...
        <div className="space-y-4">
          {CONTACT_INFO.map(({ icon, label, value, href }, i) => (
            <a key={i} href={href}
              ...
              <span className="text-[#C9A84C]/60 group-hover:text-[#C9A84C] transition-colors duration-300 flex-shrink-0">{icon}</span>
              <div className="min-w-0">
                <p className="font-cinzel text-[8px] tracking-[0.4em] text-[#C9A84C]/50 uppercase mb-1">{label}</p>
                <p className="font-cormorant text-base text-white group-hover:text-[#C9A84C] transition-colors duration-300 truncate">{value}</p>
              </div>
